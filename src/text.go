...
const DEFAULT_AGENT_PERSONA_VERBOSE = DEFAULT_AGENT_PERSONA + "You are a technical writer. You always respond in concise, precise paragraphs that describe the topic and provide a concrete code example."
